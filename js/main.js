...
const ssScrollSpy = function() {
    ...
    function navHighlight() {
        ...
        sections.forEach(function(current) {
            ...
            const sectionTop = current.offsetTop - 50; // Offset for the header
            const sectionId = current.getAttribute("id");

            // Get the navigation link corresponding to the current section
            const navLink = document.querySelector(".s-header__nav a[href='#" + sectionId + "']");

            if (navLink) { // Check if the navigation link exists
